(()=>{
  ...
  let siteId=storage.get('sjw_site_id')||'',previewUrl='',busy=false,files=[],trialRemaining=1,previewTimer=null;
  ...
  const copy={
    en:{
      ...
      trialComplete:'Free trial complete',continueCreating:'Continue creating',trialUsed:'Your free website creation has been used. Subscribe to create, redesign, and publish additional websites.',
    ...
    zh:{
      ...
      trialComplete:'免费试用已完成',continueCreating:'继续创建',trialUsed:'你的一次免费网站创建机会已经使用。订阅后可继续创建、重新设计和发布更多网站。',
  ...
  const extended={
    en:{
      ...
      loginRequired:'Sign in to continue with a paid plan.',authUnavailable:'Sign-in is not configured yet.'
    },
    zh:{
  ...
  function applyLanguage(){
    ...
    setText('#backBtn span',c.restart);setText('#previewBtn span',currentLang==='zh'?'网站预览':'Preview site');setText('#shareBtn span',currentLang==='zh'?'复制 / 转发':'Copy / share');setText('#siteManageBtn span',currentLang==='zh'?'设置与域名':'Settings & domain');setText('#publishBtn',c.publish);
  ...
  function applyManagementLanguage(){
    ...
    const values={
      manageSiteSmall:zh?'网站管理':'Website management',manageSiteTitle:zh?'管理你的网站':'Manage your website',manageSiteIntro:zh?'在一个清晰入口中管理资料、图片、发布、分享与自定义域名。':'Manage business information, images, publishing, sharing and custom domain from one clear place.',
