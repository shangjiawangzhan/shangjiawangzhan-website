const CACHE='sjw-app-v2.1.0';
const SHELL=['/','/index.html','/assets/css/app.css?v=2.1.0','/assets/js/config.js?v=2.1.0','/assets/js/api.js?v=2.1.0','/assets/js/app.js?v=2.1.0','/offline.html','/icons/icon-192.png','/icons/icon-512.png'];
