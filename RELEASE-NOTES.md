...
## v3.2.0 consolidated security and premium-layout patch

- One free website preview.
- Paid users are no longer blocked by the client-side free-preview counter.
- Render cold-start waiting time increased.
- Subscription-required errors open the membership dialog clearly.
- Generated websites use a cleaner international layout with secondary contact functions inside a compact menu.
